...
import {
    SunDim,        // Tabler: SunDim
    Sun,           // Tabler: Sun
    ChevronRight,  // Tabler: ChevronRight
    ChevronUp,     // Tabler: ChevronUp / ChevronUp
    ChevronLeft,   // Tabler: ChevronLeft
    ChevronDown,   // Tabler: ChevronDown
    Mic,           // Tabler: Mic
    Moon,          // Tabler: Moon
    SkipForward,   // Tabler: SkipForward
    StepForward,   // Tabler: StepForward
    StepBack,      // Tabler: StepBack
    Table,         // Tabler: Table
    Volume,        // Tabler: Volume
    Volume1,       // Tabler: Volume1
    Volume2,       // Tabler: Volume2
...
export const MacbookScroll = ({
    ...
    return (
        <div
            ref={ref}
            className="bg-black rleative flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-80"
        >
            {/* Lid */}
            <Lid
                src={src}
...
export const Lid = ({
    ...
    return (
        <div className="relative [perspective:800px]">
            ...
            >
                <img src="/assets/images/image02.jpg" className="inset-0 absolute z-1 rounded-2xl" alt="" />
...
const WcsLogo = () => {
    return (
        <img src="./wcs_logo.png" className="h-10 w-full" alt="" />
    );
};
