...
export const DraggableContainer = ({
    ...
    return (
        <GridVariantContext.Provider value={variant}>
            <div className="h-[60vh] md:h-dvh overflow-hidden">
                <motion.div
                    className="h-[60vh] md:h-dvh overflow-hidden"
                >
                    <motion.div
                        className={cn(
        ...
        "overflow-hidden hover:cursor-pointer w-full h-full will-change-transform",
        {
            variants: {
                variant: {
                    ...
                    polaroid:
                        "border-10 border-b-28 border-white shadow-xl even:rotate-3 odd:-rotate-2 hover:rotate-0 transition-transform ease-out duration-300 even:mt-[40%]",
                },
            },
            defaultVariants: {
                variant: "default",
