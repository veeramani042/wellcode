...
export function Iphone({
  ...
  return (
    <div
      className={`relative z-1 inline-block w-full align-middle leading-none ${className}`}
      style={{
      ...
      >
        <g mask={hasMedia ? "url(#screenPunch)" : undefined}>
          <path
            ...
            className="fill-[#E5E5E5] dark:fill-[#202020]"
          />
          <path
        ...
        <path
          ...
          className="fill-[#F5F5F5] dark:fill-[#000000]"
        />
        <path
