...
export function Safari({
    ...
    return (
        <ScrollViewTrigger>
            ...
            >
                <ImageComparison 
                    beforeImage="/assets/images/service-images/day-to-dusk/day_to_dusk_before_home.avif"
                    afterImage="/assets/images/service-images/day-to-dusk/day_to_dusk_after_home.avif"
                    altBefore="A black placeholder image with the word Before"
                    altAfter="A white placeholder image with the word After"
                    className="absolute overflow-hidden z-10000 rounded-b-xl"
                    style={{
                        left: `${LEFT_PCT}%`,
                        top: `${TOP_PCT}%`,
                        width: `${WIDTH_PCT}%`,
                ...
                >
                    ...
                    >
                        <path
                            ...
                            className="fill-[#E5E5E5] dark:fill-[#151515]"
                        />
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
